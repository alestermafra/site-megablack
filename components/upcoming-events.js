        ...
        <div className="card mt-5" style={{ backgroundColor: 'rgb(23, 23, 32)' }}>
            <div className="card-body">
                <h2 className="pb-3">
                    ...
                    {' '}
                    <a href={"https://instagram.com/" + event.instagram} className="text-decoration-none text-white" target="_blank" rel="noreferrer">
                        <span className="fs-5 text-secondary"><span className="text-danger">@</span>{event.instagram}</span>
                    </a>
                </h2>

                <div className="fs-6 mb-3">
                    <i className="bi bi-calendar-event text-danger"></i>
                    <span className="ms-3 text-uppercase">{event.date}</span>
                </div>
